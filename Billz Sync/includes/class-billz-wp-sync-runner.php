 ...
 * @package    Billz_Wp_Sync
 * @subpackage Billz_Wp_Sync/public
 * @author     Davletbaev Emil <kharbiyanov@gmail.com>
 */
class Billz_Wp_Sync_Runner {
	...
	public function billz_collect_products_action_init() {
		if ( false === as_next_scheduled_action( 'billz_collect_products' ) ) {
			as_schedule_recurring_action( strtotime( 'now' ), 60, 'billz_collect_products', array(false), 'BILLZ' );
		}
	}
